...
async def on_member_join(member):
    ...
    if channel is not None:
        tex = f"{member.mention} Welcomeแนะนำตัวด้วยนะ กด/แนะนำตัว จากนั้นทำตามที่บอทบอก {member.guild.name}!"
...
async def namecommand(interaction: discord.Interaction, name: str):
    ...
    await interaction.followup.send('ok! พิมพ์*Kตัวพิมพ์ใหญ่นะ')
